...
incident_energy_vec, sticking_probability_vec, ci_error_vec = begin data = readdlm(projectdir("figure_data","fig_S4","IESH_sticking_probability.txt"), ' ', skipstart=1); data[:, 1], data[:, 2], data[:, 3] end
