...
struct AndersonHolstein{M<:NQCModels.DiabaticModels.DiabaticModel,B,D,T} <: NQCModels.DiabaticModels.LargeDiabaticModel
    model::M
    bath::B
...
function NQCModels.potential!(model::AndersonHolstein, V::Hermitian, r::AbstractMatrix)
    ...
    fillbathcoupling!(V, Vsystem[2,1], model.bath, model.couplings_rescale) # Vsystem[2,1] Hybridization function component V_k(r)  
